...
class labelme2coco(object):
    def __init__(self, labelme_json=[], save_json_path='./new.json'):
        ...
        self.categories = [{'supercategory': 'A', 'id': 1, 'name': 'ship'},
                           {'supercategory': 'B', 'id': 2, 'name': 'water'}]
...
labelme_json = glob.glob('/home/omnisky/PycharmProjects/data/maskRcnn/mytest/1/262985539_1709e54576_z.json')
# labelme_json = glob.glob('./*.json')
# labelme_json=['./1.json']

labelme2coco(labelme_json, '/home/omnisky/PycharmProjects/data/maskRcnn/mytest/1/new1.json')